...
**Test suite today:** 148 tests, 21 files — `packages/core/test` (public API, persistence + WASM
...
npm test                    # 148 tests (core + server + shell driver contracts + web bootstrap + UI journeys)
