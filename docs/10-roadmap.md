...
**Test suite today:** 167 tests, 26 files — `packages/core/test` (public API, persistence + WASM
...
npm test                    # 167 tests (core + server + shell driver contracts + web bootstrap + UI journeys)
