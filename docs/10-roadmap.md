...
**Test suite today:** 157 tests, 24 files — `packages/core/test` (public API, persistence + WASM
...
npm test                    # 157 tests (core + server + shell driver contracts + web bootstrap + UI journeys)
