...
**Test suite today:** 168 tests, 26 files — `packages/core/test` (public API, persistence + WASM
...
npm test                    # 168 tests (core + server + shell driver contracts + web bootstrap + UI journeys)
