...
**Test suite today:** 169 tests, 26 files — `packages/core/test` (public API, persistence + WASM
...
npm test                    # 169 tests (core + server + shell driver contracts + web bootstrap + UI journeys)
