...
**Test suite today:** 149 tests, 21 files — `packages/core/test` (public API, persistence + WASM
...
npm test                    # 149 tests (core + server + shell driver contracts + web bootstrap + UI journeys)
