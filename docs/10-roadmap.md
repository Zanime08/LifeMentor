...
**Test suite today:** 166 tests, 26 files — `packages/core/test` (public API, persistence + WASM
...
npm test                    # 166 tests (core + server + shell driver contracts + web bootstrap + UI journeys)
